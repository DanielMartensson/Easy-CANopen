...
enum {
	...
	CS_LSS_SWITCH_MODE_SELECTIVE = CS_LSS_SWITCH_MODE_SELECTIVE_VENDOR_ID | CS_LSS_SWITCH_MODE_SELECTIVE_PRODUCT_CODE | CS_LSS_SWITCH_MODE_SELECTIVE_REVISION_NUMBER | CS_LSS_SWITCH_MODE_SELECTIVE_SERIAL_NUMBER,
	...
	CS_LSS_IDENTIFY_REMOTE_SLAVE = CS_LSS_IDENTIFY_REMOTE_SLAVE_VENDOR_ID | CS_LSS_IDENTIFY_REMOTE_SLAVE_PRODUCT_CODE | CS_LSS_IDENTIFY_REMOTE_SLAVE_REVISION_NUMBER_LOW | CS_LSS_IDENTIFY_REMOTE_SLAVE_REVISION_NUMBER_HIGH | CS_LSS_IDENTIFY_REMOTE_SLAVE_SERIAL_NUMBER_LOW | CS_LSS_IDENTIFY_REMOTE_SLAVE_SERIAL_NUMBER_HIGH,
	...
	CS_LSS_INQUIRE_IDENTITY = CS_LSS_INQUIRE_IDENTITY_VENDOR_ID | CS_LSS_INQUIRE_IDENTITY_PRODUCT_CODE | CS_LSS_INQUIRE_IDENTITY_REVISION_NUMBER | CS_LSS_INQUIRE_IDENTITY_SERIAL_NUMBER | CS_LSS_INQUIRE_IDENTITY_NODE_ID
};
