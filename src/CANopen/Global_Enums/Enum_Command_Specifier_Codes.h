...
enum {
	...
	CS_SWITCH_MODE_SELECTIVE_PROTOCOL = CS_SWITCH_MODE_SELECTIVE_PROTOCOL_VENDOR_ID | CS_SWITCH_MODE_SELECTIVE_PROTOCOL_PRODUCT_CODE | CS_SWITCH_MODE_SELECTIVE_PROTOCOL_REVISION_NUMBER | CS_SWITCH_MODE_SELECTIVE_PROTOCOL_SERIAL_NUMBER,
	...
	CS_INQUIRE_IDENTITY_PROTOCOL = CS_INQUIRE_IDENTITY_PROTOCOL_VENDOR_ID | CS_INQUIRE_IDENTITY_PROTOCOL_PRODUCT_CODE | CS_INQUIRE_IDENTITY_PROTOCOL_REVISION_NUMBER | CS_INQUIRE_IDENTITY_PROTOCOL_SERIAL_NUMBER | CS_INQUIRE_IDENTITY_PROTOCOL_NODE_ID
};
